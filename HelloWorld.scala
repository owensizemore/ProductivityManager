...
//    (solveArithmetic(25))
    ...
    Option 1 - typeCode (16, 64, 128)
    Option 2 - typeSentences (not reversed) (3, 6, 16)
    Option 3 - typeSentences (reversed) (2, 4, 10)
    Option 4 - findLetterInstances (3/25, 6/100, 10/150)
     */
  }

  def setPreferences(): Unit = {
    println("Please specify your preferred level of difficulty for unblocking sites:\nEasy\nMedium\nHard")
  }
